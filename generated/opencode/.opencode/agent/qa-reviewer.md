---
name: qa-reviewer
description: Inspects rendered slides with fresh eyes for layout, spacing, contrast, typography, diagram, and consistency issues; writes a QA report and returns a summary.
mode: subagent
---
