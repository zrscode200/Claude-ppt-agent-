...
### Creation
- **PptxGenJS** for creating decks from scratch (see `.opencode/skills/ppt-studio/references/pptxgenjs-guide.md`)
- **python-pptx** for programmatic reading/editing of `.pptx` files

### Editing
- **Unpack/edit/pack** workflow for XML-level editing (see `.opencode/skills/ppt-studio/references/editing-guide.md`)
...
See `.opencode/skills/ppt-studio/references/design-guide.md` for full design reference.
